/** Botão "Falar com o suporte" (WhatsApp). Some quando não há URL configurada
 * (SUPPORT_WHATSAPP_URL no .env, exposto por /auth/me e /auth/registration-status). */
export function WhatsAppSupport({ url, label }: { url?: string | null; label: string }) {
  if (!url) return null;
  return (
    <a
      href={url}
